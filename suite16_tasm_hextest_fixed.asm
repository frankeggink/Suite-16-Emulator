...
; assemble with command: tasm -s -h -c -g0 -t16 suite16_tasm_hextest_fixed.asm out.hex
; generate MEM-array with command: binToMem.exe < suite16_tasm_hextest_fixed.lst > output
